...
#pragma region meshlab_layerDialog
//
...
//{
//	//***20150413
//	//qDebug("top_ update_layerdialog_table");
...
//
//			//*******201503019 增加TexWire與ol_tess rendermode*********************************************
//			RenderModeAction *rendermodeTexWireAct = new RenderModeTexWireAction(mmd->id(), renderModeGroupAct);
//			rendermodeTexWireAct->setCheckable(true);
//			rendlist.push_back(rendermodeTexWireAct);
//
//			RenderModeAction *rendermodeOlTessAct = new RenderModeOutlineTesselation(mmd->id(), renderModeGroupAct);
//			rendermodeOlTessAct->setCheckable(true);
//			rendlist.push_back(rendermodeOlTessAct);
//			//****************************************************
//
...
//	qDebug("update_layerdialog_table");
//}
//
...
//
//}
#pragma endregion meshlab_layerDialog

#pragma region my_layerDialog
LayerDialog::LayerDialog(QWidget *parent) : QDockWidget(parent)
{
	ui = new Ui::layerDialog();
	setWindowFlags(windowFlags() | Qt::WindowStaysOnTopHint | Qt::SubWindow);
...
void LayerDialog::updateLog(GLLogStream &log)
{
	...
	pair<int, QString> logElem;
	QString preWarn = "<font face=\"courier\" size=3 color=\"red\"> Warning: ";
	QString preSystem = "<font face=\"courier\" size=2 color=\"orange\">";
	QString preFilter = "<font face=\"courier\" size=2 color=\"black\">";
...
#pragma endregion my_layerDialog