...
class RichDynamicFloat_S;
class RichDynamicFloat_spin;
class RichOpenFile;
class RichSaveFile;
class RichMesh;


class Visitor //***都為virtual 繼承者必須實作function
{
public:
...
//***20151014
class RichDynamicFloat_S : public RichParameter
{
public:
	RichDynamicFloat_S(const QString nm, const float defval, const float minval, const float maxval, const QString desc = QString(), const QString tltip = QString());
	RichDynamicFloat_S(const QString nm, const float val, const float defval, const float minval, const float maxval, const QString desc = QString(), const QString tltip = QString());
	void accept(Visitor& v);
	bool operator==(const RichParameter& rb);
	~RichDynamicFloat_S();
...
class RichDynamicFloat_spin : public RichParameter
{
public:
	RichDynamicFloat_spin(const QString nm, const float defval, const float minval, const float maxval, const QString desc = QString(), const QString tltip = QString());
	RichDynamicFloat_spin(const QString nm, const float val, const float defval, const float minval, const float maxval, const QString desc = QString(), const QString tltip = QString());
	void accept(Visitor& v);
	bool operator==(const RichParameter& rb);
	~RichDynamicFloat_spin();
...
class RichParameterXMLVisitor : public Visitor//***xml的visitor
{
public:
...
public:
    ...
    vcg::Point3<PALETTE_SCALAR> getPoint3m(QString name) const;
