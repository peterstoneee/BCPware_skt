...
QString MLXMLUtilityFunctions::generateH(const QString& basefilename,const MLXMLTree& tree )//產生header file
{
...
QString MLXMLUtilityFunctions::generateCPP(const QString& basefilename,const MLXMLTree& tree )//產生cpp檔
{
    QString result = MLXMLUtilityFunctions::generateMeshLabCodeFilePreamble() + "\n";
