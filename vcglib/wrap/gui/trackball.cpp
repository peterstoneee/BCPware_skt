...
void Trackball::setDefaultMapping () {
  ...
  //modes[BUTTON_LEFT] = new SphereMode ();//backup
  modes[BUTTON_RIGHT] = new SphereMode();

  //modes[BUTTON_LEFT | KEY_CTRL] = new PanMode ();//backup
  modes[BUTTON_RIGHT | KEY_CTRL] = new PanMode();
  ...
  //modes[BUTTON_LEFT | KEY_ALT] = new ZMode ();//backup
  modes[BUTTON_RIGHT | KEY_ALT] = new ZMode();
